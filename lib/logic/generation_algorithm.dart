...
class GenerateAlgorithms {
  static void visualize(
      {GridObstacleGeneration algorithm,
      List<List<int>> gridd,
    ...
    switch (algorithm) {
      case GridObstacleGeneration.recursive:
        recursiveMaze(
            gridd, onRemoveWall, onFinished, onShowWall, stopCallback, speed);
        break;
      ...
      case GridObstacleGeneration.backtracker:
        backtrackMaze(gridd, onShowCurrentNode, onRemoveWall, onFinished,
            onShowWall, stopCallback, speed);
        break;
      default:
    }
  }
  ...
  static void backtrackMaze(
      List<List<int>> grid,
      Function onShowCurrentNode,
      Function onRemoveWall,
      Function onFinished,
      Function onShowWall,
      Function stopCallback,
    ...
    int totalNodes = x * y;
    mazeNodes =
        List.generate(x, (i) => List.generate(y, (j) => MazeNode(i, j)));
