    ...
    return IntroductionScreen(
      pages: [
        PageViewModel(
          title: "Hey!",
          body:
              "This app visualizes different pathfinding algorithms. Some of them find the shortest path, while others trade off speed for path length.",
          // image: Center(
        ...
        PageViewModel(
          title: "Drawing tool",
          body:
              "Long press drawing tool to reveal other brush types such as start and finish node.",
          // image: Center(
          //   child: Image.network("https://domaine.com/image.png", height: 175.0),
          // ),
        ),
